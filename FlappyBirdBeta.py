...
backgroundImage = pygame.image.load("FBBackground.png")
bottomBarRect = pygame.Rect(0,windowHeight - 125,800,125)
bottomBarImage = pygame.image.load("FBBottomBar.png")
topPipeImage = pygame.image.load("FBTopPipe.png")
bottomPipeImage = pygame.image.load("FBBottomPipe.png")
greenBarImage = pygame.image.load("FBGreenBar.png")
...
while True:
    ...
    if score > topScore:
        topScore = score
        scoreChangeFile = open("FBScores.txt","w")
